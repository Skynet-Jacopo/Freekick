...
public class ChangeTeamInfoActivity1 extends BaseActivity {
...
//                ToastUtil.toastShort("小值" + (int) min + ",大值" + (int) max);
        ...
        average_height = PrefUtils.getString(App.APP_CONTEXT, "average_height", null);
        ...
        if (PrefUtils.getString(App.APP_CONTEXT, "logourl", null) == null) {
...
//                takePic();
    ...
    private void next() {
        ...
        Intent intent = new Intent(mContext, ChangeTeamInfoActivity2.class);
        ...
        intent.putExtra("color1", PrefUtils.getString(App.APP_CONTEXT, "color1", null));
        intent.putExtra("color2", PrefUtils.getString(App.APP_CONTEXT, "color2", null));
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
                        PackageManager
                                .PERMISSION_GRANTED) {
                    //没有权限，请求权限
                    ActivityCompat.requestPermissions(ChangeTeamInfoActivity1.this, new String[]{Manifest.permission
...
//                overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
    ...
    private void getImageFromCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            imageUri = FileProvider.getUriForFile(ChangeTeamInfoActivity1.this, "com.football.freekick.fileprovider",
                    outputImage);
        } else {
