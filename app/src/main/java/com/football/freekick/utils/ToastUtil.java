...
public class ToastUtil {
    ...
    public static void toastShort(int strRes) {
        if (null == App.APP_CONTEXT) {
            return;
        }
        toastShow(App.APP_CONTEXT.getString(strRes), Toast.LENGTH_SHORT, null);
    }
    ...
    public static void toastLong(int strRes) {
        ...
        toastShow(App.APP_CONTEXT.getString(strRes), Toast.LENGTH_LONG, null);
    }
    ...
    private static void ToastShowWithDrawble(String strInfo, int nKeepTime, Drawable able) {
        try {
            ...
            if (toast != null) {
                ...
                toast = Toast.makeText(App.APP_CONTEXT, strInfo, nKeepTime);
/*                LinearLayout view = (LinearLayout) toast.getView();
                ...
                toast.setView(view);*/
                toast.setGravity(Gravity.BOTTOM, 0, DisplayUtil.dip2px(App.APP_CONTEXT, 45));
            }
            toast.show();
        } catch (Exception e) {
